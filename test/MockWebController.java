...
import photoalbum.controller.AbstractController;
 ...
 * view.
 */
public class MockWebController extends AbstractController {
   ...
   */
  public MockWebController(IModel model, IWebView webView) {
    this.model = model;
